...
static inline void dw_pcie_dbi_ro_wr_en(struct dw_pcie *pci)
{
	...
	printk("pci-jason:dw_pcie_dbi_ro_wr_en is here \n");
	val = dw_pcie_readl_dbi(pci, reg);
	printk("pci-jason:PCIE_MISC_CONTROL_1_OFF is 0x%x \n",val);
	printk("pci-jason:dw_pcie_dbi_ro_wr_en is 1 here \n");
	val |= PCIE_DBI_RO_WR_EN;
	printk("pci-jason:dw_pcie_dbi_ro_wr_en is 2 here \n");
	dw_pcie_writel_dbi(pci, reg, val);
	printk("pci-jason:dw_pcie_dbi_ro_wr_en is 3 here \n");
}
